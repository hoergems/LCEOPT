...
oppt::CumulativeAnglesVec OpptODEPhysics::getCumulativeAngles() const
{
    oppt::CumulativeAnglesVec cumulativeAngles(jointNameMap_.size());
    size_t idx = 0;
...
void OpptODEPhysics::setCumulativeAngles(const oppt::CumulativeAnglesVec& cumulativeAngles)
{
