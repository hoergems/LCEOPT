...
struct HistoryEntry;
/** @brief A std::unique_ptr to a oppt::HistoryEntry */
typedef std::unique_ptr<oppt::HistoryEntry> HistoryEntryUniquePtr;
/** @brief A vector of oppt::HistoryEntryUniquePtr */
typedef std::vector<HistoryEntryUniquePtr> History;
